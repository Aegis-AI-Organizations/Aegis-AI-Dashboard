        ...
        <header className="h-16 flex items-center justify-between px-6 bg-[#0B0D13] border-b border-gray-800/60">
            <div className="flex items-center">
                <h1 className="text-white font-medium text-base hidden sm:block">
                    Vulnerability Report <span className="text-gray-500 ml-1 font-normal">- Project Template</span>
                </h1>
            ...
            <div className="flex items-center gap-4 sm:gap-6">
                <div className="relative group hidden sm:block">
                    ...
                    <div className="absolute inset-y-0 right-0 pr-2 flex items-center pointer-events-none">
                        <span className="text-xs text-gray-600 font-medium bg-[#1A1D24] px-1.5 py-0.5 rounded border border-gray-800">K</span>
                    </div>
                </div>
